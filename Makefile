all: main.cc lib/timer.o lib/keyboard.o lib/interrupt.o lib/buffer.o lib/glhelper.o lib/misc.o lib/vector.o lib/matrix.o lib/complex.o lib/kernel.o lib/patch.o lib/buffers.o
	g++ main.cc lib/timer.o lib/keyboard.o lib/interrupt.o lib/buffer.o lib/glhelper.o lib/misc.o lib/vector.o lib/matrix.o lib/complex.o lib/kernel.o lib/patch.o lib/buffers.o -o bin/main -L/usr/lib `sdl-config --cflags --libs` -lGL -lGLEW -lSDL_image
...
lib/interrupt.o: src/keyboard.h src/interrupt.h src/interrupt.cc
	g++ src/interrupt.cc -c -o lib/interrupt.o
...
lib/kernel.o: src/kernel.h src/kernel.cc
	g++ src/kernel.cc -c -o lib/kernel.o
lib/patch.o: src/patch.h src/patch.cc src/kernel.h src/buffers.h
	g++ src/patch.cc -c -o lib/patch.o
lib/buffers.o: src/buffers.h src/buffers.cc src/matrix.h src/vector.h src/kernel.h src/defines.h
	g++ src/buffers.cc -c -o lib/buffers.o
